...
*
*/
Class emolclient_connectproxy_soap {
	 /**
        ...
        */
        public function __construct($instanceName, $apiKey, $serviceName, $debug = false){
                // create a reference to the debug switch
                $this->debug            = $emolclient_isDebug;

                $this->instanceName     = $instanceName;
                
                $this->serviceName      = $serviceName;
        		$this->serviceUrl       = 'https://core.eazymatch.net';
        ...
        public function __call($name, $argu){
                ...
                try {
                        ...
                        $connectionManager = emolclient_connectManager::getInstance();
                    ...
                    ob_Clean();
                                        var_dump( $e );
                    emolclient_session::terminate();
                    exit();
                                } else {
                        ob_clean();
                        header('location: /'.get_option( 'emolclient_company_account_url' ).'/logout/');
                        exit();
                                }
                        }
